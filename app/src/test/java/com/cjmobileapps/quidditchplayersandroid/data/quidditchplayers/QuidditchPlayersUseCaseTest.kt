...
class QuidditchPlayersUseCaseTest : BaseTest() {
    ...
    @Test
    fun `getHousesFromDB() happy success flow`() = runTest {
    ...
    @Test
    fun `getHousesFromDB() throw exception`() = runTest {
    ...
    @Test
    fun `fetchHousesApi() happy success flow`() = runTest {
    ...
    @Test
    fun `fetchHousesApi() then response error at getAllHouses() error flow`() = runTest {
    ...
    @Test
    fun `fetchHousesApi() throw exception at createAllHousesToDB error flow`() = runTest {
    ...
    @Test
    fun `fetchPlayersAndPositionsApis() happy success flow`() = runTest {
    ...
    @Test
    fun `fetchPlayersAndPositionsApis() with players error response error flow`() = runTest {
    ...
    @Test
    fun `fetchPlayersAndPositionsApis() with positions error response error flow`() = runTest {
    ...
    @Test
    fun `fetchPlayersAndPositionsApis() throw exception at createAllHousesToDB error flow`() = runTest {
    ...
    @Test
    fun `getAllPlayersToDB() happy success flow`() = runTest {
    ...
    @Test
    fun `getAllPlayersToDB() throw getAllPlayersFlow() error flow`() = runTest {
