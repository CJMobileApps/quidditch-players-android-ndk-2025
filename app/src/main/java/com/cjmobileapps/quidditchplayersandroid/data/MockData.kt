...
object MockData {
    ...
    val mockHousesResponseWrapper = ResponseWrapper(
        data = mockHouses,
    ...
    val mockRavenclawPlayersResponseWrapper = ResponseWrapper(
        data = ravenclawTeam(),
        statusCode = HttpURLConnection.HTTP_OK
    )
    ...
    val mockRavenclawPlayersDeferredResponseSuccess = CompletableDeferred(
    ...
    val mockPositionsResponseWrapper = ResponseWrapper(
        data = mockPositions,
        statusCode = HttpURLConnection.HTTP_OK
    )
    ...
    val mockPositionsDeferredResponseSuccess = CompletableDeferred(
        mockPositionsResponseSuccess
    )

    /*** players and positions ***/

    val mockRavenclawPlayersAndPositionsResponseWrappers = ResponseWrappers(
    ...
    val mockRavenclawPlayersAndPositionsDeferredResponseSuccess = CompletableDeferred(
    ...
    val mockStatusResponseWrapper = ResponseWrapper(
        data = mockStatus(),
        statusCode = HttpURLConnection.HTTP_OK
    )
    ...
    val mockStatusDeferredResponseSuccess = CompletableDeferred(
